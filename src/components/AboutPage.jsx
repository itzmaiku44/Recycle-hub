    ...
    <>
      ...
      <main style={{ padding: '60px 12%', maxWidth: '900px', margin: '0 auto' }}>
        <section style={{ textAlign: 'left' }}>
          ...
          <br></br>
          <p style={{ fontSize: '1.05rem', lineHeight: 1.7 }}>
            This project is created by student of CIS2102 - WEB DEVELOPMENT 2 - Group6 S.Y. 2025.<br></br>
            Lead Developer: Michael James Catubig<br></br>
            Frontend Developer: Adam Werner T. Villa, Johndear M. Halili<br></br>
          </p>
        </section>
      </main>
    </>
