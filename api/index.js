...
// Use Prisma Client generated from server/prisma/schema.prisma
// Make sure to run: cd server && npx prisma generate before deployment
...
// Note: Routes keep /api prefix because Vercel rewrite sends full path to function
// Request to /api/auth/register → function receives /api/auth/register

// For Vercel, use /tmp for file uploads (writable directory)
const avatarsDir = process.env.VERCEL ? '/tmp/avatars' : path.join(__dirname, '..', 'server', 'avatars');
...
app.post('/api/user/avatar', upload.single('avatar'), async (req, res) => {
  try {
    ...
    // For Vercel, return a URL path (you may want to use Vercel Blob Storage instead)
...
// Initialize default rewards on cold start
